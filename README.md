# PHP-FPM Nginx API with MySQL

A simple PHP-FPM Nginx API application and MySQL, containerized with Docker.
...
```bash
git clone https://github.com/opsnoopop/api_php_fpm_nginx_mysql.git
```

### 2. Navigate to Project Directory
```bash
cd api_php_fpm_nginx_mysql
```
